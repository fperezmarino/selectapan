    ...
    def create_lab_test(self):
        ...
        for browse_record in self:
            ...
            if res_ids:                     
                ...
                action = self.env.ref('hospital_management.action_medical_lab_form')
                list_view_id = imd.sudo()._xmlid_to_res_id('hospital_management.medical_lab_tree_view')
                form_view_id  =  imd.sudo()._xmlid_to_res_id('hospital_management.medical_lab_form_view')
                result = {
                                'name': action.name,
                                'help': action.help,
                                'type': action.type,
