 ...
 def create_lab_imaging_request(self):
     for wizard_obj in self:
         ...
         if new_created_id_list:
             ...
             action = self.env.ref('hospital_management.action_medical_imaging_test_result_draft')
             list_view_id = imd.sudo()._xmlid_to_res_id('hospital_management.medical_imaging_test_request_tree')
